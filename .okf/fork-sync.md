...
- **spawn_subagent description:** `build_task_description` stays `TaskDescriptionDetail::Concise`. Do not append `task_model_guidance` inside it. The caller appends `task_model_guidance(selection, slugs)` after main added `TaskModelSelection`
