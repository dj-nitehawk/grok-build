...
| `crates/codegen/xai-grok-agent/src/prompt/prompt_encrypted.rs` | Regenerate via `python3 scripts/encrypt_templates.py` from that crate after editing `templates/*.md` |
