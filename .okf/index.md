...
Compact operational knowledge for agents working on Grok Build (`grok`), SpaceXAI's terminal AI coding agent. Read relevant files before editing. Keep synchronized with code, tests, docs, and configuration.
...
* [Workflows](workflows.md): build, run, format, generation
* [Testing](testing.md): commands, layout, fixtures
* [Fork Sync](fork-sync.md): pull `origin/main` updates onto `dev` without losing customizations
