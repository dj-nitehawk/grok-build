...
impl LspBackend for LspBackendAdapter {
    ...
    async fn notify_file_event(&self, _path: &Path, _content: Option<&str>, _kind: DiskChangeKind) {
    }
...
pub async fn restart_monitor(_mgr: std::sync::Weak<tokio::sync::Mutex<LspManager>>, _name: String) {
}
