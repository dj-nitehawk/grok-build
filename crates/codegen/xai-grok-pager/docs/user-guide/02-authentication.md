...
A separate login bills GPT-6 Astra and GPT-6 Sol turns to a ChatGPT subscription. This is unofficial (Codex CLI OAuth + `chatgpt.com` backend). See [ChatGPT Plus/Pro](chatgpt.md).
