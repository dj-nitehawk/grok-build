...
A separate login bills GPT-6 Astra turns to a ChatGPT subscription. This is unofficial (Codex CLI OAuth + `chatgpt.com` backend). See [ChatGPT Plus/Pro](chatgpt.md).
