...
mod imp {
    ...
    macro_rules! register_int_counter {
        ($name:expr, $help:expr $(,)?) => {
            ::core::result::Result::<$crate::prometheus_facade::IntCounter, &'static str>::Ok(
    ...
    macro_rules! register_int_counter_vec {
        ($name:expr, $help:expr, $labels:expr $(,)?) => {
            ::core::result::Result::<$crate::prometheus_facade::IntCounterVec, &'static str>::Ok(
    ...
    macro_rules! register_int_gauge {
        ($name:expr, $help:expr $(,)?) => {
            ::core::result::Result::<$crate::prometheus_facade::IntGauge, &'static str>::Ok(
    ...
    macro_rules! register_histogram {
        ($name:expr, $help:expr $(,)?) => {
            ::core::result::Result::<$crate::prometheus_facade::Histogram, &'static str>::Ok(
    ...
    macro_rules! register_histogram_vec {
        ($name:expr, $help:expr, $labels:expr $(,)?) => {
            ::core::result::Result::<$crate::prometheus_facade::HistogramVec, &'static str>::Ok(
