...
mod stub {
    ...
    pub mod auto_update {
        ...
        pub async fn ensure_latest_on_disk(_config: &UpdateConfig) -> Result<EnsureLatestOutcome> {
        ...
        pub async fn check_update_background(_config: &UpdateConfig) -> BackgroundUpdateCheck {
