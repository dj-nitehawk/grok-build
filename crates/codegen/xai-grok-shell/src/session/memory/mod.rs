...
pub use xai_grok_memory::{
    ...
    MemoryWatcherSyncObservation, V2ManifestBudget, V2MemoryAccessPolicy, V2MemoryScope, archive,
    backend, chunker, dream, dream_lock, embed_missing_chunks, embedding, flush, index,
