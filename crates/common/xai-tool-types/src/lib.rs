...
pub use task::{
    ...
    SubagentIsolationMode, SubagentToolNaming, TaskDescriptionDetail, TaskOutputOutput,
    ...
    build_task_description, build_task_description_with_detail, build_task_output_description,
