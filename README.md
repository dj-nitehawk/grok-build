...
| **ChatGPT** | No fork Codex integration | **GPT-6 Astra and GPT-5.6 Sol via ChatGPT Plus/Pro**, using an unofficial Codex backend |
...
Use **GPT-6 Astra** or **GPT-5.6 Sol** with a **ChatGPT Plus/Pro subscription**,
separately from Grok authentication and OpenAI API-key billing:
